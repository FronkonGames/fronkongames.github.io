...
---
## Artifacts {#artifacts}
{{< asset-header youtube="tyg11e6XrQQ" demo="https://fronkongames.github.io/demos-glitches/artifacts/">}}
...
'**Size**' (_2_): artifacts size (width x height).

'**Aberration**' (_3_): color aberration.

'**Interleave**' (_4_): interleave intensity.

'**Luminance range**' (_5_): Luminance range in which the effect is applied. If the luminance is less than luminanceRange.x or greater than luminanceRange.y, the effect is not applied.

'**Blocks**' (_6_): Intensity of the block effect. The more intensity the more interphase blocks. You can also adjust the operation used to mix the color and its color.

'**Lines**' (_7_): Intensity of the line effect. The higher the intensity, the higher the line density. You can also adjust the operation used to mix the color and its color.

---
## Hacked {#hacked}
{{< asset-header youtube="gjgyrVs8yx0" demo="https://fronkongames.github.io/demos-glitches/hacked/">}}
